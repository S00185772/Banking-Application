...
namespace Banking_Application
{
    public sealed class Current_Account: Bank_Account 
    {
        ...
        public Current_Account(String name, String password, String address_line_1, String address_line_2, String address_line_3, String town, double balance, double overdraftAmount) : base(name,password ,address_line_1, address_line_2, address_line_3, town, balance)
        {
